 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Ahmed Ghedi");
		  toPrint += p1.toString("agedi3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Yizra Gihbre");
		  toPrint += p2.toString("yghebre6");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Bianca Dankwa");
		  toPrint += p3.toString("bdankwa6");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Anton");
                  toPrint += p4.toString("aturner61");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Austin Neely");
                  toPrint += p5.toString("ANeely7");

        Person6 p6 = new Person6("Matthew Jinks");
        toPrint += p6.toString("mjinks3");
